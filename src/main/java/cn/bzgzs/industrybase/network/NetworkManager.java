...
public class NetworkManager {
	...
	public static final SimpleChannel INSTANCE = NetworkRegistry.newSimpleChannel(new ResourceLocation(Preference.MODID, "instance"), () -> VERSION, VERSION::equals, VERSION::equals);
