...
public class TransmissionRodRenderer implements BlockEntityRenderer<TransmissionRodBlockEntity> {
	...
	private static final ResourceLocation TEXTURE = new ResourceLocation(IndustryBase.MODID, ""); // TODO
	...
	public static LayerDefinition createBodyLayer() {
		...
		partdefinition.addOrReplaceChild("main", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -8.0F, -3.0F, 6.0F, 16.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
