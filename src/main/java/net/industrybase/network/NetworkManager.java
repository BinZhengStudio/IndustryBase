...
public class NetworkManager {
    ...
    private static void register(final RegisterPayloadHandlersEvent event) {
        ...
        registrar.playToClient(ReturnWireConnPacket.TYPE, ReturnWireConnPacket.STREAM_CODEC,
                ReturnWireConnPacket::handler);
        registrar.playToClient(WaterAmountPayload.TYPE, WaterAmountPayload.STREAM_CODEC, WaterAmountPayload::handler);

        registrar.playToServer(SubscribeSpeedPacket.TYPE, SubscribeSpeedPacket.STREAM_CODEC,
                SubscribeSpeedPacket::handler);
        registrar.playToServer(UnsubscribeSpeedPacket.TYPE, UnsubscribeSpeedPacket.STREAM_CODEC,
                UnsubscribeSpeedPacket::handler);
        registrar.playToServer(SubscribeWireConnPacket.TYPE, SubscribeWireConnPacket.STREAM_CODEC,
                SubscribeWireConnPacket::handler);
        registrar.playToServer(UnsubscribeWireConnPacket.TYPE, UnsubscribeWireConnPacket.STREAM_CODEC,
                UnsubscribeWireConnPacket::handler);
        registrar.playToServer(RequestWaterAmountPayload.TYPE, RequestWaterAmountPayload.STREAM_CODEC,
                RequestWaterAmountPayload::handler);
    }
}
