...
public class DiamondTransmissionRodBlock extends LayeredTransmissionRodBlock {
	public static final MapCodec<DiamondTransmissionRodBlock> CODEC = simpleCodec(DiamondTransmissionRodBlock::new);

	public DiamondTransmissionRodBlock(Properties properties) {
		super(properties, 100, 0x3BD4D4);
	}
