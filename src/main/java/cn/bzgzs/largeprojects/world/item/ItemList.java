...
public class ItemList {
	...
	public static final RegistryObject<BlockItem> STEAM_ENGINE = ITEMS.register("steam_engine", () -> new BlockItem(BlockList.STEAM_ENGINE.get(), new Item.Properties().tab(CreativeModeTabList.LARGEPROJECTS)));
	public static final RegistryObject<BlockItem> GEAR_BOX = ITEMS.register("gear_box", () -> new BlockItem(BlockList.GEAR_BOX.get(), new Item.Properties().tab(CreativeModeTabList.LARGEPROJECTS)));
}
